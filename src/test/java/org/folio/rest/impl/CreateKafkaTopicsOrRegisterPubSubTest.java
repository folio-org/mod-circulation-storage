...
class CreateKafkaTopicsOrRegisterPubSubTest {
  ...
  @Test
  void whenFlagDisabledBothKafkaTopicsAreCreatedAndPubSubIsRegistered(VertxTestContext testContext, Vertx vertx) {
    TenantRefAPI.disableNativeKafkaIntegration();
