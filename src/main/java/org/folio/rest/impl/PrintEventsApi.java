...
public class PrintEventsApi implements PrintEventsStorage {
  ...
  @Override
  public void postPrintEventsStoragePrintEvents(PrintEventsRequest printEvents, Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
