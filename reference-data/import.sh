...
dataDirs=${dataDirs:-'.'}
modEndpoints='loan-policy-storage/loan-policies request-policy-storage/request-policies notice-policy-storage/notice-policies circulation-rules-storage cancellation-reason-storage/cancellation-reasons'
